...
contract StudentData{
    ...
    fallback() external payable {
        //This function will handle external function calls that is not there our contract
    }
    receive() external payable {
        //This function will handle ether sent by external user but withour mentioned
    }
